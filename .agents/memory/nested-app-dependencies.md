...
يجب أن يحتوي مجلد التطبيق الذي يشغله الـ workflow على package.json و lockfile واعتمادياته كاملة؛ اعتماديات package.json في جذر المستودع لا تُحل تلقائيًا من imports داخل التطبيق المتداخل. وجود node_modules إضافي في الجذر قد يسبب نسخ React مكررة أثناء تحسين Vite.
