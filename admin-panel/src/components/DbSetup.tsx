    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 10 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <p style={{ fontSize: 12, color: '#94a3b8', marginTop: 2 }}>الجداول غير موجودة في Supabase — شغّل الـ SQL التالي في لوحة Supabase</p>
        </div>
        <div style={{ display: 'flex', gap: 8 }}>
          <button
            onClick={() => setOpen(o => !o)}
            style={{ background: '#1e293b', border: '1px solid #334155', color: '#94a3b8', padding: '6px 12px', borderRadius: 6, fontSize: 12, cursor: 'pointer', fontFamily: 'inherit' }}
          >
            {open ? 'إخفاء' : 'عرض SQL'}
          </button>
          <a
      ...
      {open && (
        <div style={{ marginTop: 12, position: 'relative' }}>
          <pre style={{
            ...
            padding: '14px 16px', fontSize: 11, color: '#7dd3fc', overflow: 'auto',
            maxHeight: 280, fontFamily: 'monospace', direction: 'ltr', textAlign: 'left',
            lineHeight: 1.6,
          }}>
            {SQL}
          </pre>
