...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    'nav.adminManagement': 'إدارة المشرفين',
    'nav.operations': 'التشغيل والمتابعة',
    'nav.tools': 'الأدوات والربط',
    'nav.reports': 'السجلات والشكاوى',
  ...
  en: {
    ...
    'nav.tools': 'Tools & Integrations',
    'nav.reports': 'Logs & Complaints',
